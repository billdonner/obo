...
Family flashcard deck for the Donner grandchildren. Players are the cousins at the bottom of the tree — George, Will, Teddy, Nell — who play on obo-ios and get personalized questions about their family.
...
### Generation 3 — Grandchildren (PLAYERS)

| Person | Born | Parents | Notes |
|--------|------|---------|-------|
| **George Donner** | 2018 | Andrew & Katherine | Oldest cousin |
| **Will Donner** | 2021 | Andrew & Katherine | Twin with Teddy |
| **Teddy Donner** | 2021 | Andrew & Katherine | Twin with Will |
| **Nell Donner** | 2023 | Charlie & Madeleine | Only girl cousin |
| TBD boy | Jul 2026 | James & Angela | Not yet born |

### Todd Side (Katherine's family)

| Person | Nickname | Relationship |
|--------|----------|-------------|
| Bill Todd | **Grandpa Bill** | Katherine & John's father |
| Elizabeth Todd | **GB** | Katherine & John's mother |
| John Todd | — | Katherine's brother, b.~1983 |
| Bryce Todd | — | John's son, b.~2025 |

### Cristiano Side (Angela's family)

| Person | Nickname | Relationship |
|--------|----------|-------------|
| Steve Cristiano | — | Angela's father |
| Adele Cristiano | **Dell** | Angela's mother |
| Sister A | — | Angela's sister (placeholder), has 2yo child |
| Sister B | — | Angela's sister (placeholder), expecting Aug 2026 |

## Key Naming Rules

- Bill Donner = **Poobah** (always, never "Grandpa Bill")
- Bill Todd = **Grandpa Bill**
- Sheryl = **May May**
- Elizabeth Todd = **GB**
- Charles = **Charlie**
...
Questions are personalized per player (cousin). Each player gets questions oriented to their perspective:

- **Tier 1 (Easy, ages 3-5)**: "What is Poobah's real name?" / "Who are the twins?"
- **Tier 2 (Medium, ages 5-8)**: "What is May May's maiden name?" / "Which uncle is the oldest?"
- **Tier 3 (Hard, ages 8-12)**: "Who is Bryce's father?" / relationship chain questions
- **Tier 4 (Expert, ages 10+)**: "Name all cousins oldest to youngest" / family trivia
